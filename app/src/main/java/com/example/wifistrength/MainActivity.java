...
public class MainActivity extends AppCompatActivity {
    ...
    private void savetofile(){
        ...
        File directory = new File(getFilesDir() + File.separator +"wifistrength");
        if (!directory.exists())
        ...
        File file = new File(getFilesDir() + File.separator +"wifistrength" + File.separator + "wifistrength.txt");
